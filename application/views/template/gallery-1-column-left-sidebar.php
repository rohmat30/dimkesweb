    ...
    <!--Title / Beadcrumb-->
         	<div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            	<div class="bread-heading"><h1>Gallery 1 Column Left Sidebar</h1></div>
                <div class="bread-crumb pull-right">
                <ul>
                <li><a href="index.html">Home</a></li>
                <li><a href="about-us-1.html">Gallery 1 Column Left Sidebar</a></li>
                </ul>
                </div>
            </div>
         </div>
         ...
         <div class="container">
           ...
           <div class="row"> 
        	...
        	<div class="col-md-12 col-xs-12 col-sm-12 pull-left subtitle ibg-transparent">Showcase Your Content</div>
			          ...
			          <div class="doctors-3col-tabs test">
  <ul class="nav nav-tabs tab-acc hidden-xs" id="myTab">
                        <li class=""><a href="#all-doc" data-toggle="tab">All Doctors</a></li>
                        <li class=""><a href="#primary-health" data-toggle="tab">Health Care</a></li>
                        <li class="active"><a href="#pediatric-clinic" data-toggle="tab">Pediatric Clinic</a></li>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 pull-left side-bar-blog-bottom">
             ...
             <div class="col-xs-12 col-sm-12 col-md-8 pull-right no-pad doctors-3col-tabs gallery-3col-tabs">
         		...
         		<div class="content-tabs col-xs-12 col-sm-12">
                      ...
                      <div class="tab-content">
                        ...
                        <div class="tab-pane fade fade-slow in active" id="all-doc">
                         ...
                         <!--Doc intro-->
                        <div class="doctor-box no-pad col-md-12 col-sm-6 col-xs-12 wow fadeInDown animated" data-wow-delay="0.5s" data-wow-offset="200">
                        ...
                        <div class="doc-name">
                         ...
                         <!--Doc intro-->
                        <div class="doctor-box no-pad col-md-12 col-sm-6 col-xs-12 wow fadeInUp animated" data-wow-delay="0.5s" data-wow-offset="200">
                        ...
                        <div class="tab-pane fade fade-slow" id="primary-health">
                             ...
                             <!--Doc intro-->
                        <div class="doctor-box no-pad col-md-12 col-sm-6 col-xs-12">
