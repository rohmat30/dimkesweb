    ...
    <section class="complete-content content-footer-space">
      <div id="gallery-two-left-sidebar"> 
      <!--Mid Content Start-->
      ...
      <!--Title / Beadcrumb-->
           	<div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
              	<div class="bread-heading"><h1>Gallery 2 Columns Left Sidebar</h1></div>
                  <div class="bread-crumb pull-right">
                  <ul>
                  <li><a href="index.html">Home</a></li>
                  <li><a href="about-us-1.html">Gallery 2 Columns Left Sidebar</a></li>
                  </ul>
                  </div>
              </div>
           </div>
           ...
           <div class="container">
              ...
              <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 side-bar-blog">
               ...
               <div class="col-xs-12 col-sm-12 col-md-8 pull-right doctors-3col-tabs no-pad">
                    ...
                    <!--Doc intro-->
                        ...
                        <div class="doctor-box col-md-6 col-sm-6 col-xs-12 wow fadeInUp animated" data-wow-delay="0.5s" data-wow-offset="200">
                         ...
                         <!--Doc intro-->
                        <div class="doctor-box col-md-6 col-sm-6 col-xs-12 wow fadeInDown animated" data-wow-delay="0.5s" data-wow-offset="200">
