    ...
    <!--Title / Beadcrumb-->
         	<div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            	<div class="bread-heading"><h1>Contact Version 1</h1></div>
                <div class="bread-crumb pull-right">
                <ul>
                <li><a href="index.html">Home</a></li>
                <li><a href="about-us-1.html">Contact Version 1</a></li>
                </ul>
                </div>
            </div>
         </div>
                ...
                <div class="row">
                    ...
                    <div class="contact-widgets">
                        ...
                        <div class="contact-widget-box col-md-3 col-lg-3 col-sm-6 col-xs-12 wow bounceIn" data-wow-delay="1.1s" data-wow-offset="150">
                            ...
                            <p><a href="mailto:contact@imedica.com">contact@imedica.com</a></p>
                        </div>
