...
<nav class="navbar clearHeader">
    <div class="col-12">
        <div class="navbar-header"> <a href="javascript:void(0);" class="bars"></a> <a class="navbar-brand" href="index.html">Dinkes</a> </div>
...
<section class="content" style="min-height: 1700px">
    <div class="container-fluid">
        <div class="block-header">
            <h2><?php echo isset($title) ? $title : 'Dashboard'?></h2>
        </div>
